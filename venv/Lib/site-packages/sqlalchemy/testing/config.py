...
def combinations(*comb, **kw):
    ...
    :param id\_: optional id Templates.  This is a string Templates that
     describes how the "id" for each parameter set should be defined, if any.
     The number of characters in the Templates should match the number of
     ...
     character value in the same position within the string Templates using the
     following scheme::
